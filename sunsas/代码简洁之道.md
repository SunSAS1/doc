...
***
## 6.1.3 Java7 try-with-resources
...
我们使用普通的try/finally时，如果try抛出了异常，catch捕捉到。然后去finally，但是如果finally也抛出了一个异常，那么前面的异常就会被屏蔽掉。只会打印finally的异常，但这个异常并不是“真正的异常”，因为我们肯定是想看try中的异常信息。
